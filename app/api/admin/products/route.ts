...
export async function POST(request: NextRequest) {
  try {
    ...
    const parsed = productSchema.safeParse({
      ...
      goldPurity: body.gold_purity || '22K',
      availableInBothPurities: body.available_in_both_purities || false,
    ...
    const { data, error } = await supabase
      ...
      .insert([{
        ...
        gold_purity: v.goldPurity,
        available_in_both_purities: v.availableInBothPurities,
...
export async function PATCH(request: NextRequest) {
  try {
    ...
    if (fields.gold_purity !== undefined)        toValidate.goldPurity = fields.gold_purity;
    if (fields.available_in_both_purities !== undefined) toValidate.availableInBothPurities = fields.available_in_both_purities;
    ...
    if (v.goldPurity !== undefined)         updates.gold_purity = v.goldPurity;
    if (v.availableInBothPurities !== undefined) updates.available_in_both_purities = v.availableInBothPurities;
