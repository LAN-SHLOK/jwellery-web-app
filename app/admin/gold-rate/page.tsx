          ...
          <GoldPanel delay={0.14}>
            ...
            <form className="mt-8 space-y-6" onSubmit={handleUpdate}>
              ...
              <button
                disabled={isUpdating}
                type="submit"
                className="group relative w-full overflow-hidden rounded-full bg-gradient-to-r from-amber-600 to-amber-500 py-5 font-semibold text-white shadow-lg shadow-amber-500/30 transition-all hover:shadow-xl hover:shadow-amber-500/40 disabled:cursor-not-allowed disabled:opacity-60"
              >
                <div className="relative z-10 flex items-center justify-center gap-2">
                  {isUpdating ? <RefreshCcw className="animate-spin" size={18} /> : <Save size={18} />}
                  <span className="text-base">Save Market Rate</span>
                </div>
                {/* Shine effect */}
